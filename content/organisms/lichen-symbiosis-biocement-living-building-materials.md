...
The answer — as engineers have discovered — is yes. The **Lichen** (*Cladonia rangiferina*) has evolved a
solution to this problem that is elegant, efficient, and increasingly influential across
environmental technology, construction, biotechnology. This page explains what the lichen does, why it matters to
...
The lichen lives in Arctic tundra, exposed rock faces worldwide. Over millions of years of evolutionary pressure,
...
an extraordinarily long and selective optimization process. Every feature of the lichen
